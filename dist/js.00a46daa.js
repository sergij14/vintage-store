...
var cart = document.querySelector(".nav__cart");
var cartTotal = document.querySelector(".nav__cart__total");
var bagCartItems = document.querySelector(".nav__cart-count");
var store = document.querySelector(".store__items");
var cartList = [];
var buttons = []; ////////////////////////////////////////////////////////
// Cart & Nav Toggle
////////////////////////////////////////////////////////
...
var cartShow = function cartShow() {
...
var UI = /*#__PURE__*/function () {
  ...
  _createClass(UI, [{
    ...
    value: function getBagButtons() {
      var btns = _toConsumableArray(document.querySelectorAll(".store__item__btn"));

      buttons = btns;
      btns.forEach(function (btn) {
        var id = btn.dataset.id;
        var inCart = cartList.find(function (item) {
          return item.id === id;
        });
    ...
    value: function cartLogic() {
      ...
      var cartClearBtn = document.querySelector(".nav__cart__clear-btn");
      ...
      cart.addEventListener("click", function (event) {
        if (event.target.classList.contains("nav__cart__item__remove-btn")) {
          ...
          var tempItem = cartList.find(function (item) {
            return item.id === _id;
          });
          tempItem.amount += 1;
          Storage.saveCart(cartList);
          ...
          var _tempItem = cartList.find(function (item) {
            return item.id === _id2;
          });
...
var Storage = /*#__PURE__*/function () {
  ...
  _createClass(Storage, null, [{
    ...
    key: "saveCart",
    value: function saveCart(cartList) {
